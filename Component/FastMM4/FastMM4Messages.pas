...
const
  ...
  FreeModifiedDetailMsg = #13#10#13#10'对已释放内存块内容的修改的偏移 (和长度): ';
  ...
  CurrentThreadIDMsg = #13#10#13#10'当前线程ID thread ID 是 0x';
  CurrentStackTraceMsg = ', 导致该错误的当前堆栈跟踪(调用返回地址):';
...
{$endif}
    + ': ';
  BytesMessage = ' 字节: ';
  AnsiStringBlockMessage = '单字节字符串 AnsiString';
  UnicodeStringBlockMessage = '双字节字符串 UnicodeString';
