...
{$IFDEF UNICODE}uses  Vcl.Consts ; {$ENDIF UNICODE}
...
begin
  inherited Create;
//  DebugOut.DebugOutStr('TLogLogger.Create 初始化 FCriticalLogger  '+Name+' 地址:'+getIntHex(integer(@FCriticalLogger),4));
...
//  DebugOut.DebugOutStr('TLogLogger.Destory 删除 FCriticalLogger  '+FName+' 地址:'+getIntHex(integer(@FCriticalLogger),4));
  inherited Destroy;
end;
...
begin
//  DebugOut.DebugOutStr('申请加锁 '+FName+' 地址:'+getIntHex(integer(@FCriticalLogger),4));
  EnterCriticalSection(FCriticalLogger);
//    DebugOut.DebugOutStr('加锁完成 '+FName+' 地址:'+getIntHex(integer(@FCriticalLogger),4));
//  DebugOut.DebugOutStr('加锁成功 TLogLogger.LockLogger EnterCriticalSection(FCriticalLogger) '+FName+' 地址:'+getIntHex(integer(self),4));
end;
...
begin
//  DebugOut.DebugOutStr('申请解锁'+FName+'  地址:'+getIntHex(integer(@FCriticalLogger),4));
//  DebugOut.DebugOutStr('申请解锁 TLogLogger.UnlockLogger LeaveCriticalSection(FCriticalLogger) '+FName+' 地址:'+getIntHex(integer(self),4));
  LeaveCriticalSection(FCriticalLogger);
//  DebugOut.DebugOutStr('解锁完成'+FName+'  地址:'+getIntHex(integer(@FCriticalLogger),4));

//  DebugOut.DebugOutStr('解锁成功 TLogLogger.UnlockLogger LeaveCriticalSection(FCriticalLogger) '+FName+' 地址:'+getIntHex(integer(self),4));
end;
